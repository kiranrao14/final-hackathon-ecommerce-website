  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow mt-10 mb-12 container mx-auto px-6 py-10 bg-[#F0F2F3] border-b-4 border-gray-400 shadow-lg rounded-lg">
            ...
            <div className="flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="bg-[#33c4d1] text-white px-4 py-2 rounded mt-6 font-bold hover:bg-[#4e9ca3]"
                >
                  Add to Cart
                </button>
                <button
